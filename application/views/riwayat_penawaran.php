                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($m->status_lelang == "open") : ?>
                                        <a href="<?= site_url('page/delete_penawaran/' . $m->id_penawaran) ?>" data-delete-url="<?= site_url('page/delete_penawaran/' . $m->id_penawaran) ?>" onclick="deleteConfirm(this)"><button type="button" class="btn btn-danger" title="Hapus">Hapus</button></a>
                                    <?php endif ?>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
