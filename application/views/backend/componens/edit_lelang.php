        ...
        <div class="ibox-body">
            <form class="form-horizontal" method="post"  enctype="multipart/form-data">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="id_barang" value="<?= $barang->nama_barang ?>"readonly>
                    </div>
                </div> 
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <button type="submit" name="upadate" class="btn btn-success" value="upadate">Update</button>
                    </div>
                </div>
        </form>
    </div>
