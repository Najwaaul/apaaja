                                ...
                                <?php foreach ($gambar as $b) : ?>
                                    <tr>
                                        ...
                                        <?php if ($barang->status <> "Sold") : ?>
                                            <td>
                                                <!-- Delete -->
                                                <a href="<?= site_url('backend/barang/hapus_gambar/' . $b->id_gambar) ?>" onclick="deleteConfirm(this)"><button type="button" class="btn btn-danger" title="Hapus"><i class=" fa-solid fa-trash"></i></button></a>
                                            </td>
                                        <?php endif ?>
                                    </tr>
                                <?php endforeach ?>
