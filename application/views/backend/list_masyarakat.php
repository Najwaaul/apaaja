    ...
    <main class="main">
        ...
        <div class="content">
            ...
            <tr>
                ...
                <td><?= $m -> status ?></td>
                <td>
                <a href="<?= base_url('backend/masyarakat/blokir/'. $m->id_masyarakat) ?>" data="#" class="btn btn-danger btn-sm item-delete"><i class="fa-solid fa-lock"></i></fa-solid> </a>
                <a href="<?= base_url('backend/masyarakat/aktifkan/'. $m->id_masyarakat) ?>" data="#" class="btn btn-info btn-sm item-delete"><i class="fa fa-check"></i> </a>
